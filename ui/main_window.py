...
class MainWindow(QMainWindow):
    ...
    def _clients_tab(self):
        ...
        tip = QLabel("💡 MVP: pour l’instant, ajoute/édite les clients directement dans data/clients.json")
    ...
    def _accounting_tab(self):
        ...
        lay.addWidget(QLabel(f"Écritures comptables: {n}"))
    ...
    def _settings_tab(self):
        ...
        lay.addWidget(QLabel("MVP: édition via JSON; connexion Google dans une prochaine itération."))
        return w
    ...
    def _fake_pdf(self):
        QMessageBox.information(
            self, "PDF",
            "La génération PDF sera branchée sur les templates HTML.\n(MVP placeholder)"
        )
